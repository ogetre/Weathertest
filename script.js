...
function settimebg(){
    ...
    if(date.getHours()>20){
        ...
        document.getElementById("bgsun").style.width = "0px"
...
async function getWeatherByCity(city) {
    ...
    try {
        ...
        weathercnd = data.current.condition.text;
        for(let i =1; i<10;i++ ){
...
async function preparelist(){
    ...
    <div id = "locationsaveddiv" onclick=getWeatherByCity('${savedcities[i]}') class = "locationsaveddiv${i}" >
    <div id = "firstcl">
